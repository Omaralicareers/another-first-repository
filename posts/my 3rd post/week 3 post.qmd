...
3.  Explain the difference between the source editor view and visual editor view in Rstudio. The source is plain text while the visual interprets the plain text as a formatted. For example \<www.google.com\>
